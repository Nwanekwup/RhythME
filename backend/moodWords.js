const moodWords = {
    ...
    Sad: ['sad', 'cry', 'tears', 'sorrow', 'melancholy', 'leave', 'grief', 'mournful', 'heartbroken', 'depressed', 'gloomy', 'despondent', 'dejected', 'somber', 'downcast', 'wistful', 'forlorn', 'lament', 'dismal', 'blue', 'unhappy'],
    ...
    Confident: ['confident', 'bold', 'sure', 'certain', 'assertive', 'self-assured', 'fearless', 'poised', 'determined', 'lion', 'tiger', 'secure', 'unwavering', 'gutsy', 'strong', 'self-reliant', 'assured', 'decisive', 'audacious', 'commanding', 'self-confident', 'empowered'],
    ...
    Stressed: ['stress', 'anxiety', 'stressed', 'tense', 'worry', 'pressure', 'overwhelmed', 'strained', 'uptight', 'frazzled', 'distressed', 'agitated', 'nervous', 'restless', 'jittery', 'panicked', 'frantic', 'troubled', 'flustered', 'uneasy', 'burdened'],
    Romantic: ['love', 'romance', 'passion', 'heart', 'affection', 'adore', 'cherish', 'sweetheart', 'beloved', 'amorous', 'infatuated', 'intimate', 'shape','tender', 'affectionate', 'ardent', 'darling', 'devoted', 'enamored', 'fondness', 'soulmate'],
};
